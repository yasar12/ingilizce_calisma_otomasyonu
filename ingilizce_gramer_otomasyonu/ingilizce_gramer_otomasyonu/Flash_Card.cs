     ...
     public   ArrayList bilinemeyen_Kelimeler=new ArrayList();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            if(!cevapVerildimi&&button5.Text!="")
            {
                if(!cevapGosterme)
                cevapVerildimi = true;
           label1.Text=cevapGosterme.ToString();
...
button2.Text = cevap+","+cevap2;
        ...
        public void KartDondurmeSesi() {
            ...
            player.SoundLocation = @"C:\Users\hello\source\repos\ingilizce_gramer_otomasyonu\ingilizce_gramer_otomasyonu\bin\Debug\card_flip.wav";
            player.Play();
        }
