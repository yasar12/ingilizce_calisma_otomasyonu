...
namespace database
{
    public class Class1
    {
        public string databaseaddress= "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=C:\\Users\\hello\\Documents\\ingilizce_otomasyon_database.accdb";
        public string komut="";
      public  OleDbConnection conn;
       ...
       public OleDbDataReader reader;
        ...
        public void bilgiguncelle(string komut, string databaseaddress,string degisilceksutunismi,bool deger)
        {
            ...
            command.Parameters.AddWithValue("@RecordID",degisilceksutunismi); // Güncellenecek kaydın ID'si
